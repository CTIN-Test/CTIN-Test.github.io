(function() {
    ...
    function initHeader() {
        ...
        for(var i in points) {
            var c = new Circle(points[i], 3 + Math.random() * 3, 'rgba(0,0,0,1)');
            points[i].circle = c;
        }
    }
    ...
    function drawLines(p) {
        ...
        for(var i in p.closest) {
            ...
            //ctx.strokeStyle = 'rgba(20,213,219,'+ p.active+')';
            ctx.strokeStyle = 'rgba(239,69,98,'+ p.active+')';
            ctx.stroke();
        }
    }
    ...
    function Circle(pos,rad,color) {
        ...
        this.draw = function() {
            ...
            //ctx.fillStyle = 'rgba(239,69,98,'+ _this.active+')';
            ctx.fillStyle = 'rgba(20,213,219,'+ _this.active+')';
